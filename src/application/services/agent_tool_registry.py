...
_GAP_SUGGESTIONS: tuple[tuple[str, str, str], ...] = (
    ...
    ("foreign", "get_ticker_foreign_flow", "cache-only foreign net-flow trend series"),
    ("asing", "get_ticker_foreign_flow", "cache-only foreign net-flow trend series"),
    ("smart_money", "get_ticker_foreign_flow", "cache-only foreign net-flow trend series"),
    ("desk_history", "get_ticker_desk_flow_history", "multi-session desk persistence"),
    ("persist", "get_ticker_desk_flow_history", "multi-session desk persistence"),
    ("streak", "get_ticker_desk_flow_history", "multi-session desk persistence"),
    ("sector", "get_ticker_sector_context", "peer + sector-macro context facts"),
    ("peer", "get_ticker_sector_context", "peer + sector-macro context facts"),
    ("rotation", "get_ticker_sector_context", "peer + sector-macro context facts"),
    ("earnings", "get_ticker_fundamentals_trend", "EPS history + latest ratios + forward"),
    ("eps", "get_ticker_fundamentals_trend", "EPS history + latest ratios + forward"),
    ("fundamentals", "get_ticker_fundamentals_trend", "EPS history + latest ratios + forward"),
    ("piotroski", "get_ticker_fundamentals_trend", "EPS history + latest ratios + forward"),
    ("regime", "get_market_regime", "market-wide regime + factor cache snapshot"),
    ("breadth", "get_market_regime", "market-wide regime + factor cache snapshot"),
    ("market_context", "get_market_regime", "market-wide regime + factor cache snapshot"),
    ("risk_on", "get_market_regime", "market-wide regime + factor cache snapshot"),
    ("risk_off", "get_market_regime", "market-wide regime + factor cache snapshot"),
    ("research_brief", "get_ticker_research_brief", "composed one-shot ticker brief"),
    ("brief", "get_ticker_research_brief", "composed one-shot ticker brief"),
    ("dossier", "get_ticker_research_brief", "composed one-shot ticker brief"),
