...
_COMMON_MATERIAL_CONFIG_PATHS_BASE: tuple[str, ...] = (
    ...
    "accumulation_screener.filters.min_accum_score.enabled",
    "accumulation_screener.filters.min_accum_score.value",
    ...
    "signal_engine.input_mapping.accum_score.clamp",
    "signal_engine.input_mapping.accum_score.max_score",
...
_COILED_SPRING_SETUP_PATHS: tuple[str, ...] = (
    ...
    "swing_setups.setups.coiled-spring.gates.min_accum_score",
...
_SMART_MONEY_CONFIRMED_SETUP_PATHS: tuple[str, ...] = (
    ...
    "swing_setups.setups.smart-money-confirmed.gates.min_accum_score",
...
_PULLBACK_CONTINUATION_SETUP_PATHS: tuple[str, ...] = (
    ...
    "swing_setups.setups.pullback-continuation.gates.min_accum_score",
