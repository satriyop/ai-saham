...
Plain-text multi-surface formatters live in ``adapters.shared.view_broker_desk_text``
(ADR-045). This module keeps CLI Rich ``display_*`` and re-exports shared helpers.
