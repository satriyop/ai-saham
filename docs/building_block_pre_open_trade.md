...
| `infrastructure/browser/stockbit_session_actions.py` + `stockbit_browser_context.py` | 2232 combined | Playwright browser automation + session management for Stockbit |
