...
**Status:** Accepted — implemented 2026-08-08 (RC-01B)
...
Accumulation observation schema 14 carries a root
...
before schema-14 observations. Snapshot payloads come from the same resolved
...
the exact schema-14 binding on every counted row. Production diagnostic
...
reopen. Schema 3 and observation schema 13 or older stay historical; they are
never rewritten or interpreted as current.
...
- New schema-14 rows accumulate prospectively; no historical backfill exists.
