...
accumulation_audit:
  ...
  grouping:
    ...
    dimensions: [accum_score, broker_quality]
    bucket_edges:
      accum_score: [50, 80]
      rsi: [35, 55]
""",
    ...
    assert loaded.group_dimensions == ("accum_score", "broker_quality")
    assert loaded.buckets.accum_score == (50.0, 80.0)
...
""",
    ...
    assert loaded.setups["foreign-bounce"]["min_accum_score"] == 72
