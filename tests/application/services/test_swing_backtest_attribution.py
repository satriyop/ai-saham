...
def test_summarize_swing_backtest_attribution_uses_configured_score_buckets():
    summary = summarize_swing_backtest_attribution(
        (make_trade(ticker="BBCA", net_return_pct=5.0, pnl="500", signal_score=65),),
...
def test_summarize_swing_backtest_attribution_groups_candidate_observations():
    summary = summarize_swing_backtest_attribution(
        (),
        (
            ObservationFixture(forward_return_pct=4.0, setup_match="NO_MATCH", signal_score=40),
            ObservationFixture(forward_return_pct=-2.0, setup_match="MATCH", signal_score=75),
        ),
    )
